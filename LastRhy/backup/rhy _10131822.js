...
class Administrator {
    ...
    tick() {
        ...
        */
        ...
        } else if(sheet[j2].count + 8 < i2) { //遅すぎ
            sheet[j2].type1 = "00" + sheet[j2].type1.slice(2,5);
            sheet[j2].type2 = "00" + sheet[j2].type2.slice(2,5);
        } else { //ok

            if(Con.Rlast === sheet[j2].type1.slice(0,2)) {
                sheet[j2].type1 = "00" + sheet[j2].type1.slice(2,5);
            } else if(Con.Rlast === sheet[j2].type2.slice(0,2)) {
                sheet[j2].type2 = "00" + sheet[j2].type2.slice(2,5);
            }

            if(Con.Llast === sheet[j2].type1.slice(0,2)) {
                sheet[j2].type1 = "00" + sheet[j2].type1.slice(2,5);
            } else if(Con.Llast === sheet[j2].type2.slice(0,2)) {
                sheet[j2].type2 = "00" + sheet[j2].type2.slice(2,5);
            }
        ...
        //ニュートラルに戻す
        Con.Rlast = Con.Rlast.charAt(0) + "n";
        Con.Llast = Con.Llast.charAt(0) + "n";
        
    }

    verdict() {
        let t = Math.floor((Math.abs(sheet[j2].count - i2))/2);

        switch(t) {
            case 0: this.COOL ++; this.COMBO++; break;
            case 1: this.FINE ++; this.COMBO++; break;
            case 2: this.SAFE ++; this.COMBO = 0;break;
            case 3: this.SAD ++; this.COMBO = 0; break;
            case 4: this.WORST ++; this.COMBO = 0; break;
        }
...
let bpm = 158;
let delay = 1300
let sheet1 = "";
...
console.log(x.slice(x.length-2,x.length+1));